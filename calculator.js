        ...
        try {
            ...
            this.results = {
                ...
                summary: {
                    ...
                    averageGrossWithdrawal: results.length > 0 ? totalWithdrawn / results.length : 0,
                    averageWithdrawalByMethod: (() => {
                        const divisor = showMaxMonths ? results.length : Math.min(requestedMonths, results.length);
                        if (divisor <= 0) return 0;
                        return withdrawalMethod === 'gross' ? totalNet / divisor : totalWithdrawn / divisor;
                    })(),
                    requestedMonths: requestedMonths,
